...
func CreateCSV(w http.ResponseWriter, r *http.Request) {
	...
	matches := []string{
		// "1-57093027-40d8-4005-8d0d-2a0db30bdbbf", //2
		...
		// "1-863c1135-4eae-4f42-8318-fa11ac4d786e", //10
		...
		// "1-87044324-78e7-4721-b4cc-876cd0da6a05", //20
		...
		// "1-d16e0176-d236-47b0-ad17-b72c9508e0ae", //30
		...
		// "1-8b7cd53d-9c5a-4eb0-b676-3d148afa7b05", //40
		...
		// "1-7a2428d1-fb70-4efe-9d0c-8b98cb7bd62a", //50
		...
		"1-95435ef4-182b-4f1b-ae28-dd9bdb87a51e", //60
		...
		"1-b3d9fa8f-6aaf-4c43-904f-fde73bc6c91a", //68
	}
...
func createHeader(player string) string {
	return fmt.Sprintf("%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s",
		...
		"P"+player+"_A_Deaths",
		"P"+player+"_HSPercent",
		"P"+player+"_A_HSPercent",
		"P"+player+"_KillPerRound",
		"P"+player+"_A_KillDeathRating",
		"P"+player+"_KillPerRound",
		"P"+player+"_A_KillDeathRating")
}
